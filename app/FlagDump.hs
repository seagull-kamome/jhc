...
data Flag =
    ...
    | Qualified         -- ^ show qualified names in error messages
...
one "qualified" = Right $ Set.insert Qualified
one "no-qualified" = Right $ Set.delete Qualified
